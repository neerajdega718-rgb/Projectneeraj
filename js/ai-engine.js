...
const aiEngine = {
    ...
    async getCompletion(prompt, systemPrompt = "You are a helpful student tutor.") {
        ...
        const casualReplies = ["hi", "hello", "hey", "yo", "namaste", "hola", "wow", "ok", "okay", "cool", "nice", "great", "awesome", "thanks", "thank you", "bye", "goodbye", "haha", "lol", "omg", "no", "yes", "yeah", "yep", "nope", "sure", "fine", "good", "bad", "sad", "happy", "love", "hate", "hmm", "oh", "ah", "um", "uh", "sup", "bro", "dude", "k", "kk", "nyc", "thx", "ty", "gn", "gm", "wait", "what", "huh", "nah", "yup", "true", "false", "maybe", "idk", "brb", "np", "welcome", "congrats", "congratulations", "rip", "wow", "oops", "damn", "cya", "peace", "byebye", "tysm", "appreciate", "how are you", "how are you doing", "nice to see you", "good to see you", "its been a while", "it's been a while", "hey there", "whats up", "what's up", "sup?", "yo!", "how r u", "how ru", "howve you been", "how have you been", "long time", "what's good", "whats good", "how's it going", "how is it going", "how do you do", "pleased to meet you", "nice meeting you", "good morning", "good evening", "good night", "see you", "see ya", "catch you later", "take care", "all good", "im good", "i'm good", "doing well", "cant complain", "can't complain", "same here", "you too", "thanks you", "thnk you", "tnx", "tyvm", "much appreciated", "cheers", "no worries", "no problem", "my pleasure", "anytime"];
